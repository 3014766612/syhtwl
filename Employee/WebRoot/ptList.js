layui.extend({
    ...
    var tableIns = table.render({
        elem: '#PtList',
        url : '/Employee/ptallservlet?action=productseleall',
        toolbar: '#toolbarDemo',
        page : true,
        height: 'full-145',
        limit : 10,
        ...
        cols : [[
        	{fixed:"left",type: "checkbox", width:50},
             ...
             {field: 'ptname', title: '名称', minWidth:100, align:"center"}
    ...
    $("#doSubmit").click(function(){
     ...
     //工具栏事件
	  table.on('toolbar(PtList)', function(obj){
    ...
    function uppt(id){
    	layui.layer.open({
    		title : "修改用户信息",
    		type : 2,
    		content : "/Employee/ptup.jsp",
    		area:['400px','540px'],
    		success:function(layero, index){
    			$.ajax({
    				url:"/Employee/XiuChaCP",
    				type:"post",
    				data:{"id":id},
    				success:function(data){
    					...
    					body.find("#ptname").val(info.ptname);
    					/*------下拉框赋值--------*/
    					/*$.ajax({
    ...
    function addpt(){
    	layui.layer.open({
    		title : "添加用户",
    		type : 2,
    		content : "/Employee/ptadd.jsp",//admin/page/system/user/userAdd.jsp
    		area:['400px','490px'],
    	})
    }
